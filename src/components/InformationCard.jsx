...
const InformationCard = ({ classNameTestimoni, image, classNameTagLine, tagLine, classNameDescription, description, classNameAuthor, author, profesi, classBtnPrevAndNext="hidden", prevOnClick, nextOnClick }) => {
  return (
